        ...
        <div class="flex justify-between items-end mb-8">
            <div>
                <h2 class="text-3xl font-bold font-['Oswald'] tracking-wide uppercase mb-1">
                    <span class="text-white">Add New</span> <span class="text-[#e52a2a]">Brand</span>
                </h2>
                <p class="text-[#666] text-sm">Register a new manufacturer to the dealership catalog.</p>
            </div>
            ...
            <form action="{{ route('admin.brands.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div>
                    ...
                    <input type="text" id="brand_name" name="brand_name" value="{{ old('brand_name') }}" required
                        class="w-full bg-[#050505]/50 border border-[#333] text-white text-base rounded-xl focus:ring-1 focus:ring-[#e52a2a] focus:border-[#e52a2a] px-5 py-4 transition-all placeholder-[#444] shadow-inner" 
                ...
                <div x-data="imageUploader()">
                    <label class="block text-xs font-bold text-[#888] uppercase tracking-widest mb-3">Official Logo</label>
                    ...
                    >
                        ...
                        <div x-show="!previewUrl" class="flex flex-col items-center justify-center py-8 text-center" x-transition>
                            ...
                            <p class="text-xs text-[#555]">SVG, PNG, JPG or WEBP (Max. 2MB)</p>
                        </div>
                    ...
                    <div x-show="fileName" class="mt-3 flex justify-between items-center text-xs text-[#666]" style="display: none;">
                        <span x-text="fileName" class="truncate max-w-[200px] font-medium text-[#aaa]"></span>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('imageUploader', (existingUrl = null) => ({
                ...
                removeFile() {
                    this.previewUrl = existingUrl; // Revert to original if editing, or null if creating
                    this.fileName = null;
                    this.fileSize = null;
