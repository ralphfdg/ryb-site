...
@section('content')
<div class="bg-ryb-darker min-h-screen w-full">
    ...
    <div class="relative h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 text-center px-4 max-w-4xl mx-auto mt-20">
            <h1 class="text-4xl md:text-6xl font-bold text-white mb-4 tracking-tight">Driven by <span class="text-ryb-red">Excellence</span></h1>
            <p class="text-lg text-ryb-light/80">Redefining the premium automotive retail experience.</p>
        </div>
    </div>

    {{-- ===== OUR STORY (Base Level) ===== --}}
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            
            <div>
                <h2 class="text-3xl font-bold text-white mb-6">Our <span class="text-ryb-red">Story</span></h2>
    ...
    {{-- ===== THE RYB STANDARD (Mid Level) ===== --}}
    <div class="bg-ryb-dark border-y border-ryb-muted py-20 shadow-inner">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-bold text-white mb-4">The RYB <span class="text-ryb-red">Standard</span></h2>
                <p class="text-ryb-light/60">The principles that drive everything we do.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                
                {{-- Standard Cards (Elevated to Base Level to pop out from Mid Level background) --}}
                <div class="bg-ryb-darker border border-ryb-muted rounded-2xl p-8 text-center hover:-translate-y-2 transition duration-300 shadow-xl shadow-black/40 group">
                    <div class="w-16 h-16 mx-auto bg-ryb-dark border border-ryb-red rounded-full flex items-center justify-center mb-6 group-hover:bg-ryb-red transition duration-300">
                        <svg class="w-8 h-8 text-ryb-red group-hover:text-white transition" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    </div>
                    <h3 class="text-xl font-bold text-white mb-3">Uncompromising Quality</h3>
                ...
                <div class="bg-ryb-darker border border-ryb-muted rounded-2xl p-8 text-center hover:-translate-y-2 transition duration-300 shadow-xl shadow-black/40 group">
                    <div class="w-16 h-16 mx-auto bg-ryb-dark border border-ryb-red rounded-full flex items-center justify-center mb-6 group-hover:bg-ryb-red transition duration-300">
                        <svg class="w-8 h-8 text-ryb-red group-hover:text-white transition" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path></svg>
                    </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        <h2 class="text-3xl font-bold text-white mb-6">Ready to find your dream car?</h2>
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            <a href="{{ route('catalog.index') }}" class="px-8 py-4 bg-ryb-red text-white font-bold rounded-full hover:bg-ryb-red-dark transition shadow-lg shadow-black/50 border border-ryb-red-dark">Browse Inventory</a>
        </div>
    </div>
